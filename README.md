...
📦 **Descargar Instalador:** [Últimas Versiones / Releases](https://weblocalstudio.github.io/Skrynix/releases)
...
1. Ve a la sección de **[Releases](https://weblocalstudio.github.io/Skrynix/releases)** en la parte derecha de este repositorio.
...
## 💻 Desarrollo y Compilación (Para Programadores)

Si eres desarrollador y quieres modificar el código de Skrynix o añadir nuevas funciones, puedes clonar y compilar el proyecto tú mismo desde Xcode:

```bash
# Clonar el repositorio
git clone [https://github.com/weblocalstudio/Skrynix.git](https://github.com/weblocalstudio/Skrynix.git)
